...
def randomSlopes_NUTS(num_warmup=1000, num_samples=1000, num_chains=2, rng_seed=0):
    ...
    file_path = os.path.join("simplicity_bias", "data","glme_numpyro_"+str(num_warmup)+"_"+str(num_samples)+"_coarse_seed"+str(rng_seed)+".pickle")
...
def fit_nuts_np(data, num_warmup=1000, num_samples=1000, num_chains=1,
    ...
    """
    numpyro.set_host_device_count(num_chains)
    kernel = NUTS(powerlaw_logit_model_coarse,
